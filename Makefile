##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.1.0] date: [Mon Nov 11 23:09:40 CST 2024] 
##########################################################################################################################
...
HARDWARE/LED/led.c \
HARDWARE/IIC/iic.c \
HARDWARE/printf/printf.c \
HARDWARE/printf/syscalls.c \
HARDWARE/DEBUG/log.c \
HARDWARE/mpu6050/eMPL/inv_mpu.c \
...
OBJECTS_CPP = $(addprefix $(BUILD_DIR)/,$(notdir $(CPP_SOURCES:.cpp=.cpp.o)))
